...
try:
    ...
    with open(file_src, "rb") as file:
        while True:
            ...
            clientSocket.sendto(
                file_data, dest
            )  # Lê e envia partes do arquivo em segmentos de 1024 bytes.
...
file_name, serverAddress = clientSocket.recvfrom(1024)
...
while True:
    ...
    dcount += 1
    print(f"datagram {dcount} recebido do servidor ({serverAddress})")
