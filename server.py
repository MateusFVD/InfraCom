...
try:
    file_name_bytes, client_address = server_socket.recvfrom(BUFFER_SIZE) # recebe o nome do arquivo em bytes e o endereço de quem enviou (cliente)!! necessário para retornar o arquivo
    
    file_name = file_name_bytes.decode() # decodificando para string
    server_file_name = "server_" + file_name # cria o nome do arquivo que será salvo no servidor!
